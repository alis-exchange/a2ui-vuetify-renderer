...
const catalog = {
      ...
      allOf: [
        ...
        { $ref: '#/$defs/CatalogComponentCommon' },
        {
          ...
          properties: {
            ...
            name: {
              oneOf: [{ type: 'string' }, { type: 'object', properties: { path: { type: 'string' } }, required: ['path'] }],
            },
          },
      ...
      allOf: [
        ...
        { $ref: '#/$defs/Checkable' },
        {
          ...
          properties: {
            ...
            color: { type: 'string' },
            multiple: {
              oneOf: [{ type: 'boolean' }, { type: 'string', enum: ['range'] }],
            },
  ...
  functions: {
    ...
    formatString: {
      type: 'object',
      description:
        'Performs string interpolation of data model values and other functions in the catalog functions list and returns the resulting string. The value string can contain interpolated expressions in the `${expression}` format.',
      properties: {
